...
echo "=== Figure 3: dynamic S(q,omega) at r_s=${FIG3_RS}, T=${FIG3_T} K (q in [0.1, 50]) ==="
"$SIM" "$FIG3_RS" "$FIG3_T"
...
echo "Done. Figures written to output/S_*_{contour,wide_contour}.pdf and output/plasmon_dispersion.pdf"
