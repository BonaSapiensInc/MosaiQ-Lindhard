...
Figs.~\ref{fig:S_ee}--\ref{fig:S_ei} summarize the three diagonal and cross-channel structure factors
$S_{ee}$, $S_{ii}$, and $S_{ei}$ obtained from this run, each rendered as a separate logarithmic contour map on the causal evaluation pipeline above.
...
\panelpagefigure{../output/S_ii_contour.pdf}{Fig.~3(b)}{fig:S_ii}
\panelpagefigure{../output/S_ei_contour.pdf}{Fig.~3(c)}{fig:S_ei}
