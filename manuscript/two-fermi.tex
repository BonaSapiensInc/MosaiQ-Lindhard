\documentclass[showpacs,superscriptaddress,pre,preprint]{revtex4-1}
\usepackage{graphicx}
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{tikz}
...
\begin{document}
\title{Classical linear response representation of two-fermion plasmas}
...
\begin{abstract}
This document summarizes a method for mapping an from a quantum system to a corresponding classical one for electron-ion plasmas within the two-interacting Fermi fluids model.

\end{abstract}
\pacs{52.27.Aj, 05.20.Jj, 05.30.Fk}
\maketitle
