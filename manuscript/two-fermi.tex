...
Due to the extreme mass asymmetry ($m_i/m_e \gg 1$), the ion manifolds in Figs.~\ref{fig:chi_i_re} and~\ref{fig:chi_i_im} require a kinematic Golden Scale: an expanded momentum horizon $\bar{q} \in [0, 50.0]$ together with an extreme low-frequency zoom $\bar{\omega} \in [0, 0.20]$.
...
Fig.~\ref{fig:S_ii} applies the same ion Golden Scale ($\bar{q} \in [0, 50.0]$, $\bar{\omega} \in [0, 0.20]$) to $|S_{ii}|$, framing the low-frequency ion-acoustic collective ridge.
...
\begin{itemize}
    ...
    Figs.~\ref{fig:chi_i_re} and~\ref{fig:chi_i_im} show $|\Re \chi_{i}^L|$ and $|\Im \chi_{i}^L|$ on the ion Golden Scale $\bar{q} \in [0, 50.0]$ and $\bar{\omega} \in [0, 0.20]$, magnifying the acoustic band that would otherwise be compressed against the origin on the electron frequency axis.
    ...
    Fig.~\ref{fig:S_ii} shows $|S_{ii}|$ on the ion Golden Scale $\bar{q} \in [0, 50.0]$ and $\bar{\omega} \in [0, 0.20]$, isolating the low-frequency ion-acoustic collective mode.
