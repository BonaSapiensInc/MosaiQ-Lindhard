...
Figures~\ref{fig:S_ee}--\ref{fig:S_ei} summarize the three diagonal and cross-channel structure factors
$S_{ee}$, $S_{ii}$, and $S_{ei}$ obtained from this run.
...
\centering
\includegraphics[width=0.85\textwidth]{../output/S_ee_plot.png}
\caption{Dynamic structure factors from the SOPHUS-Lindhard deterministic sandbox at $r_s = 1.0$ and $T = 10{,}000\,\mathrm{K}$. \textbf{(a)} $S_{ee}(\bar{q}, \bar{\omega})$: electron-electron structure factor. Each panel combines a two-dimensional contour map (upper) and a three-dimensional surface plot (lower) on the same $(\bar{q}, \bar{\omega})$ grid.}
\label{fig:S_ee}
\end{figure}
...
\centering
\includegraphics[width=0.85\textwidth]{../output/S_ii_plot.png}
\caption{Dynamic structure factors from the SOPHUS-Lindhard engine. \textbf{(b)} $S_{ii}(\bar{q}, \bar{\omega})$: ion-ion (ion-acoustic) structure factor.}
\label{fig:S_ii}
\end{figure}
...
\centering
\includegraphics[width=0.85\textwidth]{../output/S_ei_plot.png}
\caption{Dynamic structure factors from the SOPHUS-Lindhard engine. \textbf{(c)} $S_{ei}(\bar{q}, \bar{\omega})$: electron-ion cross structure factor.}
\label{fig:S_ei}
\end{figure}
